...
import {Container, PrimaryButton, ProfileCard, Title} from "@/components/index.js";
    ...
    <footer className=" relative bg-primary py-16 mt-16">
      ...
      <Container className={`${isHomePage ? "mt-32" : "mt-0"} flex flex-col md:flex-row justify-between gap-12`}>
        <div className="w-full md:w-1/3">
          ...
          <br />
          <p className="text-gray-300">Created with the collaboration of over 60 of the worlds best artists.</p>
